...
board = ggplot() + 
    ...
    geom_line(
              data = data.frame(
              rep(red_data_clean[1,1], 2) -0.05,
              c(top_start,top_start-0.19)),
              aes(x = (rep(red_data_clean[1,1] -0.05)),
    ...
    geom_point(
              data = data.frame(
              rep(red_data_clean[1,1], 3) -0.05,
              seq(1.04, 0.89, (-0.15)/2)
              ), 
              aes(x=rep(red_data_clean[1,1], 3) -0.05,
...
# binding data sets
coordinates = rbind(blue_data, red_data)
